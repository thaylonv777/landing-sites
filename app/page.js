  ...
  return (
    <header className={`hd ${scrolled ? "hd-on" : ""}`}>
      <div className="hd-in">
        ...
        <a href={WHATSAPP} onClick={trackWa} target="_blank" rel="noopener" className="hd-cta">
          Falar no WhatsApp
        </a>
      </div>
    </header>
    ...
    <section className="hero">
      ...
      <div className="hero-in">
        ...
        <div className="hero-actions reveal d4">
          <a href={WHATSAPP} onClick={trackWa} target="_blank" rel="noopener" className="btn-primary">
            Quero meu site
            <Arrow />
          </a>
    ...
    <section className="cta">
      <div className="cta-in reveal">
        <div className="cta-plate display">
          ...
          <a href={WHATSAPP} onClick={trackWa} target="_blank" rel="noopener" className="btn-primary btn-lg">
            Falar no WhatsApp
            <Arrow />
          </a>
        </div>
      ...
      <div className="ft-in">
        <div className="ft-top">
          ...
          <nav className="ft-nav">
            ...
            <a href="#diferenciais">O que entregamos</a>
            <a href="#video">Como funciona</a>
            <a href={WHATSAPP} onClick={trackWa} target="_blank" rel="noopener">WhatsApp</a>
          </nav>
        </div>
...
function WaFloat() {
  return (
    <a href={WHATSAPP} onClick={trackWa} target="_blank" rel="noopener" className="wa" aria-label="Falar no WhatsApp">
      <WaIcon />
